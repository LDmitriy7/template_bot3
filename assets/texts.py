...
stub = Ts('Бот временно не работает...', ua='Бот тимчасово не працює...')

main_menu = Ts('Главное меню:', ua='Головне меню:')

no_my_ads = Ts('У вас еще нет объявлений', ua='У вас ще немає оголошень')
...
creating_ad_info = Ts(_, ua=_ua)

ask_regional_city = Ts('Выберите областной город:', ua='Виберіть обласне місто:')

ask_city = Ts('Выберите один из городов:', ua='Виберіть одне з міст:')
...
ask_institution_type = Ts(_, ua=_ua)
...
ask_institution_name = Ts(_, ua=_ua)
...
ask_institution_address = Ts(_, ua=_ua)
...
ask_work_experience = Ts(_, ua=_ua)
...
ask_additional_info = Ts(_, ua=_ua)
